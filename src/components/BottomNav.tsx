...
import { Home, Fingerprint, Microscope, MessageSquareText } from 'lucide-react';
...
export const BottomNav: React.FC<BottomNavProps> = ({ currentTab, setCurrentTab }) => {
  return (
    <nav className="md:hidden fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-2 pb-safe h-16 bg-[#fbf9fb] border-t border-[#c5c6cd] shadow-lg">
      <button
        onClick={() => {
          setCurrentTab('home');
